...
const AgentView = ({userId}: AgentViewProps) => {
    ...
    useEffect(() => {
        userService.loadAgentData(userId)
            .then((res: any) => {
                setData(res);
                console.log(res);
            })
                        ...
                        >
                            ...
                            >
                                <GridItem colSpan={6} minH = '300px'>
                                    <Card direction = 'column' w = '100%' h = '100%'>
                                        <HStack justify = 'space-between'>
                                            <h1>Spending History - <Highlight>Total: ${data.spending.totalSpending}</Highlight></h1>
                                            <HStack>
                                                <FiExternalLink />
                                                <p> Expand</p>
                                            </HStack>
                                ...
                                <GridItem colSpan={6} minH = '300px'>
                                    <Card direction = 'column' w = '100%' h = '100%' >
                                        <HStack justify = 'space-between'>
                                            <h1>Revenue History - <Highlight>Total: ${data.revenue.revenueSpending}</Highlight></h1>
                                            <HStack>
                                                <FiExternalLink />
                                                <p> Expand</p>
                                            </HStack>
