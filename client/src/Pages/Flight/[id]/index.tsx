      ...
      {!isLoading && (
        <Layout>
          ...
          <SelectedFlight direction="column" w="100%" padding="1rem">
            <h1>
              Departing Flight -{" "}
              {new Date(flight.departure_date).toLocaleTimeString("en-us")}
            </h1>
            <Flex
              justify="space-between"
              direction={
                screenType === "s" || screenType === "xs" ? "column" : "row"
              }
            >
              <FlightTimeInfo>
                <HStack>
                  ...
                  <MediumText>
                    ...
                    {new Date(flight.departure_date).getMinutes() < 10
                      ? "0"
                      : ""}
          ...
          <Flex w="100%" marginTop="1rem">
            <h1 style={{ fontWeight: "bolder", fontSize: "1.2rem" }}>
              Booking Options
            </h1>
          </Flex>
          <BookingOptions direction="column" w="100%">
            ...
            >
              <h1>
                <span>Booking Agent:</span> Angelina Jolie
              </h1>
              <HStack>
