...
export const loadStaffData = (userId: string) => {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    fetch(
      `https://projectaero-api.herokuapp.com/flights/${userData.airline_name}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const loadAgentData = (userId: string) => {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    await fetch(
      `https://projectaero-api.herokuapp.com/user/${userId}/revenue`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    await fetch(
      `https://projectaero-api.herokuapp.com/user/${userId}/spending`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
    ...
    await fetch(
      `https://projectaero-api.herokuapp.com/user/${userId}/tickets`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
